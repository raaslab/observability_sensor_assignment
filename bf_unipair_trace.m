% we use the brute-force algorithm to calculate the best combination of 8
% sensors assigned to 3 targets in unique pair assignment by using trace.
global u_max
...
% % % %Set up the movie.
% writerObj = VideoWriter('gre_unique_trace.avi'); % Name it.
