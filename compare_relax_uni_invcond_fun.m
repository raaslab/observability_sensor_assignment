%compare the perfect pair assignment and unique pair assignment with invcond
% this function describe how to make perfect matching and unique pair assignment
function [perfectvalue, unique_value, r_pair_t_index] = compare_relax_uni_invcond_fun(M,pr,pt)
...
% perfect assignment
[perfectvalue, ~, ~]=bipartite_matching(invcond_nn_m);
